...
$html .= '<img src="' . htmlspecialchars($publicUrl) . '" alt="Signature Société" border="0" style="width:150px;">';
        }
    ...
    foreach ($locataires as $i => $loc) {
        ...
        if (!empty($loc['signature_data']) && preg_match('/^uploads\/signatures\//', $loc['signature_data'])) {
			...
			$html .= '<img src="' . htmlspecialchars($publicUrl) . '" alt="Signature Locataire" border="0" style="width:150px;">';
        }
