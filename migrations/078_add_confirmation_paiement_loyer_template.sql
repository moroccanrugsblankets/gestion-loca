-- Migration 078: Ajout du template email de confirmation de réception de paiement de loyer
-- Date: 2026-03-01
-- Description: Crée un nouveau template pour envoyer une confirmation de réception de paiement
--              aux locataires après chaque règlement de loyer.
...
INSERT INTO email_templates (
    ...
    'Confirmation de réception de votre paiement - {{periode}}',
    '<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    'Template pour confirmer la réception du paiement de loyer au locataire. Envoyé automatiquement lors du règlement d''un loyer.',
    1,
