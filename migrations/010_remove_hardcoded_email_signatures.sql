-- Migration: Remove hardcoded email signatures from templates
-- Date: 2026-01-30
-- Description: Remove hardcoded signatures from email templates and use dynamic {{Signature}} variable instead

-- Update candidature_recue template - Remove hardcoded signature
...
-- Update candidature_acceptee template - Remove hardcoded signature
UPDATE email_templates 
SET 
    corps_html = '<!DOCTYPE html>
<html lang="fr">
...
-- Update candidature_refusee template - Remove hardcoded signature
UPDATE email_templates 
SET 
    corps_html = '<!DOCTYPE html>
<html lang="fr">
