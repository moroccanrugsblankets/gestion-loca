...
SELECT 'inventaire_template_html', '<!DOCTYPE html>
<html lang=\"fr\">
<head>
    <meta charset=\"UTF-8\">
    <title>Inventaire d\'Entrée - {{reference}}</title>
...
</html>', 'Template HTML personnalisé pour l\'inventaire d\'entrée'
WHERE NOT EXISTS (SELECT 1 FROM parametres WHERE cle = 'inventaire_template_html');

INSERT INTO parametres (cle, valeur, description)
SELECT 'inventaire_sortie_template_html', '<!DOCTYPE html>
<html lang=\"fr\">
<head>
    <meta charset=\"UTF-8\">
    <title>Inventaire de Sortie - {{reference}}</title>
...
</html>', 'Template HTML personnalisé pour l\'inventaire de sortie'
