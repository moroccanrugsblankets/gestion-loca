-- Base de données pour le système de gestion des candidatures locatives
-- My Invest Immobilier - Système complet
-- Version 2.0

CREATE DATABASE IF NOT EXISTS myinvest_location CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE myinvest_location;
